...
from model.common import PYTORCH_MODELS_DIR, ERROR_CODE, VAL_RATIO, TEST_RATIO, PYTORCH_LOSS_MAPPING, PYTORCH_OPT_MAPPING
from model.model_p.pytorch_model import Model


class ClassifierMixin(Model):
	"""
	...
	def make_loss_fn(self, params, class_weights=None):
		...
		"""
		loss_fn = PYTORCH_LOSS_MAPPING.get(params['loss'])
	...
	def make_optimizer(self, params, model_params):
		...
		"""
		optimizer = PYTORCH_OPT_MAPPING.get(params['opt']['name'])
